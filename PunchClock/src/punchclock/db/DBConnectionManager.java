...
public class DBConnectionManager {
	 ...
	 * first time this method is called. Singletone | Double-Checked Locking
	 *
	 ...
	 */
	private void createPools(SafeProperties props)
	{
		...
		while (propNames.hasMoreElements())
		{
			...
			if (name.endsWith(".url"))
			{
				...
				try
				{
					String user = props.getSafeProperty(poolName + ".user");
					String password = props.getSafeProperty(poolName + ".password");
					String maxconn = props.getSafeProperty(poolName + ".maxconn", "0");
	...
	{
		String logFile;
		SafeProperties dbProps = new SafeProperties();
		try
		{
			String currentDir = System.getProperty("user.dir");
//			String currentDir = System.getProperty("BASEDIR");
			currentDir = currentDir.replace('\\', '/');
			currentDir = currentDir.substring(currentDir.indexOf('/'));
			dbProps.load(currentDir + "/properties/db.properties");
			logFile = dbProps.getSafeProperty("logfile", "DBConnectionManager.log");
		}
		catch (Exception e)
		{
	 ...
	 * @param props The connection pool properties
	 */
	private void loadDrivers(SafeProperties props)
	{
		try
		{
			String driverClasses = props.getSafeProperty("drivers");
